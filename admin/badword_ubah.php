...
<div class="home">
	...
	<div id="menuutama">
		<ul id="menu">
			...
			<li><a href="chat.php">Shoutbox</a></li>
             <li><a href="">Kelola Komentar</a></li>
            <li><a href="badword.php">Kelola Badword</a></li>
			<li><a href="logout.php">Keluar</a></li>
		</ul>
	</div>
	Mengubah Badword<hr><br>
	...
	$bacaCencor=mysql_fetch_array(mysql_query("select * from cencor where id_cencor='$nomer'"));
	
	$badword = $bacaCencor['badword'];

	?>
	
	<table>
	<form action="proses_ubahBad.php" method="POST">
		<tr><td>ID Cencor : <input type="text" name="id" id="id" value= "<?php echo $nomer; ?>" readonly></td></tr>
		<tr><td>Badwords Lama : <input type="text" name="lama" id="lama"  value= "<?php echo $badword; ?>" readonly></td></tr>
		<tr><td>Badwords Baru : <input type="text" name="baru" id="baru" required></td></tr>

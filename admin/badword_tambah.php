...
<div class="home">
	...
	Tambah Daftar Badword<hr><br>
	
	<table>
	<form action="proses_tmbhBad.php" method="POST">
		<tr><td>Tambahkan Badword :</td></tr>
		<tr><td><input type="text" name="tambah" id="tambah" required></td></tr>
